...
\begin{frame}{What Is Cost-Benefit Analysis?}
  ...
  \begin{itemize}
    ...
    \item Some benefits (a life saved, an hour of time, a species preserved) have \textbf{no market price at all}.
...
\begin{frame}{Cash-Flow Accounting and Opportunity Cost}
  ...
  \end{block}
  \vspace{0.4em}
  \small The general rule: economic costs are only those costs that come from \textbf{diverting} a resource away from its next best use --- not simply what the government happens to pay for it.
\end{frame}
...
\begin{frame}{Sources}
  ...
  \begin{columns}[T]
    \begin{column}{0.34\textwidth}
      Ashenfelter, O. \& Greenstone, M. (2004), \emph{AER} 94(2).
    \end{column}
    \begin{column}{0.34\textwidth}
      Diamond, P. \& Hausman, J. (1994), \emph{JEP} 8(4).\\
      Gruber, J., \emph{Public Finance and Public Policy}, Ch.\ 8.
    \end{column}
    \begin{column}{0.34\textwidth}
      Saez, E., \emph{Econ 131} lecture notes, UC Berkeley.\\
      Weitzman, M.\ (1998), \emph{JEEM} 36(3).
    \end{column}
  \end{columns}
\end{frame}
