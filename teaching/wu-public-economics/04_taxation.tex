...
\begin{frame}{The Same Five Types, in Austria}
  ...
  \end{center}
  \centering
  Every category from the textbook's typology has a direct Austrian counterpart --- often more than one.\\
  \srcnote{Bundesministerium für Finanzen (BMF); Lecture 1 (Pendlerpauschale, CO\textsubscript{2}-Bepreisung).}
\end{frame}
