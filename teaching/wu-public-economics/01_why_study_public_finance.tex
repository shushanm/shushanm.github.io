...
\begin{frame}{Austria Today: One of the Largest Governments in the EU}
  ...
  \begin{tikzpicture}
    \begin{axis}[
      ...
      ymin=0, ymax=65,
      symbolic x coords={OECD avg.,EU avg.,Germany,Austria,France,Finland},
      xtick=data,
      ...
      \addplot[fill=wublue] coordinates {
        (OECD avg.,42) (EU avg.,49) (Germany,49.5) (Austria,56.3) (France,57.1) (Finland,57.6)
      };
    \end{axis}
  \end{tikzpicture}
  \end{center}
  ...
  \srcnote{Eurostat; Statistik Austria (2024); Statistisches Bundesamt (Destatis, 2025); OECD Government at a Glance.}
\end{frame}
...
\begin{frame}{Sources (1/3): Textbook, Legislation \& Institutions}
  ...
  \setlength{\itemsep}{1pt}
    ...
    \item Fiskalrat-Büro, Pressemitteilung ``Aktueller Budgetausblick 2024 und 2025'' (5 Nov.\ 2024)
...
\begin{frame}{Sources (2/3): Statistics}
  ...
  \setlength{\itemsep}{2pt}
    \item Statistik Austria: Staatsausgaben nach Aufgabenbereichen; Sozialquote/ESSPROS (2023); EU-SILC income and living conditions (2023); Maastricht notification (2025)
    ...
    \item Eurostat; OECD \emph{Government at a Glance}; Statistisches Bundesamt (Destatis, 2025)
  \end{itemize}
\end{frame}
