...
\begin{frame}{Fact 2: Decentralization --- Who Spends, Who Taxes?}
  \footnotesize
  Austria, like Germany, is organized as a federal state with three levels: \emph{Bund}, \emph{Länder}, and \emph{Gemeinden}.
  \vspace{0.4em}
  ...
  \srcnote{KDZ -- Zentrum für Verwaltungsforschung, ``Österreichs Föderalismus: OECD-Vergleich zeigt Reformbedarf''; profil.at, ``Finanzausgleich: Riesensummen fließen an Länder und Gemeinden.''}
\end{frame}
