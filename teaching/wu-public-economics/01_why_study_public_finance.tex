...
\begin{frame}{Government Spending Across the EU --- and the US}
  ...
  \end{center}
  \centering \small
  Austria (\textbf{56.3\%}) is well above the EU/OECD averages and the US (39.1\%) --- but below France and Finland.\\
  \srcnote{Eurostat (2024, EU countries); Destatis (2025, Germany); OECD \emph{Government at a Glance 2025} (US, OECD avg., 2023).}
\end{frame}
...
\begin{frame}{Fact 2: Decentralization --- Who Spends, Who Taxes?}
  ...
  \srcnote{Agenda Austria, ``Eine Ausgabenschranke für den Staatshaushalt'' (fiscal-federalism chapter).}
\end{frame}
...
\begin{frame}{Sources (2/3): Statistics}
  ...
  \setlength{\itemsep}{2pt}
    ...
    \item Agenda Austria: ``Eine Ausgabenschranke für den Staatshaushalt'' (fiscal federalism); ``Steuern und Abgaben auf einen Blick'' (tax structure)
    ...
    \item Eurostat, government finance statistics (2024); OECD \emph{Government at a Glance 2025}; Statistisches Bundesamt (Destatis, 2025)
  \end{itemize}
\end{frame}
